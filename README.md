...
## Backup
To backup your user data, you'll need your [UUID](/Getting%20UUID) and NodeJS installed to your system. Then open a terminal in the same directory as this project and enter the following commands:
```bash
